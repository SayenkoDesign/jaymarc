	...
	<div class="grid">
		...
		<div class="grid-item grid-item-left">
			<div class="grid-item-wrapper">
				...
				<div class="overlay">
					<div class="text">
						<h3 class="h2"><?php the_field('title_left'); ?></h3>
						...
						?>
							<div class="acf-button-wrapper stacked">
								<a class="acf-button reversed" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><span class=""><?php echo esc_html($link_title); ?></span></a>
							</div>
						<?php endif;
						?>
					</div>
		...
		<div class="grid-item grid-item-right">
			<div class="grid-item-wrapper">
				...
				<div class="overlay">
					<div class="text">
						<h3 class="h2"><?php the_field('title_right'); ?></h3>
